package smart_city_management_system.Resident_Management;
...
public class ViewResident extends javax.swing.JFrame {
    public ViewResident() {
        initComponents();
        loadRecords();
    }
    ...
    private void initComponents() {
        ...
        title2.setText("VIEW RESIDENTS HERE");
 ...
 private void loadRecords() {
        ...
        try {
            File myObj = new File("Residents.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewResident.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewResident().setVisible(true);
            }
        });
    }
